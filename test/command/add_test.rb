...
describe Command::Add do
    ...
    it "adds multiple files to the index" do
        ...
        rugit_cmd "add", "hello.txt", "world.txt"
    ...
    it "adds a directory name to the index" do
